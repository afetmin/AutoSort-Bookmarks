...
function buildPrompt(
  ...
  return [
    ...
    '- prefer existing folders when they fit',
    '- do not force an existing folder when it is semantically unrelated',
    '- create a new folder only when no existing option is a good fit',
